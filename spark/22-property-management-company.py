...
def etl(prop_landlords, prop_properties):
  ...
  prop_landlords = prop_landlords.dropDuplicates(['landlord_id'])

  prop_properties = prop_properties.dropDuplicates(['property_id'])

  prop_rental_income = prop_landlords.join(
    prop_properties,
    how = 'inner',
    on = 'landlord_id'
  )

  prop_rental_income = prop_rental_income.select(
    F.col('landlord_id'),
  ...
  prop_rental_income = (prop_rental_income
                        .groupBy('landlord_id', 'landlord_name')
                        .agg(F.sum(F.col('rent')).alias('total_rental_income')))

  return prop_rental_income