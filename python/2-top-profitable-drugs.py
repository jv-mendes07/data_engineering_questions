...
def etl(input_df):
  ...
  input_df['total_profit'] = round(input_df['total_sales'] - input_df['cogs'], 2)

  input_df = input_df.sort_values(by = 'total_profit', ascending = False)

  input_df = input_df[['drug', 'total_profit']].head(3)
